...
class StyletronClient {
  constructor(opts = {}) {
    ...
    this.styleCache = new MultiCache(styleIdGenerator, (media, _cache, insertAtIndex) => {
      ...
      if (insertAtIndex >= this.container.children.length) {
        ...
        this.container.insertBefore(styleElement, this.container.children[insertAtIndex]);
      }
...
class StyletronServer {
  ...
  getStylesheets() {
    return [...(this.fontFaceRules.length ? [{
