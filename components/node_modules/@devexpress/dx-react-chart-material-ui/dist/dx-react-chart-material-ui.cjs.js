...
var Overlay = styles$h.withStyles(styles$c)(function (_ref) {
  var classes = _ref.classes,
...
var styles$e = function styles(theme) {
  ...
  return {
    ...
    'arrow-right': {
      width: "".concat(arrowSize * 2.5, "px"),
      height: "".concat(arrowSize * 5, "px"),
      position: 'absolute',
      top: '50%',
      left: 0,
...
var Arrow = styles$h.withStyles(styles$e)(function (_ref) {
  var classes = _ref.classes,
      className = _ref.className,
