...
var BasicData = function (_a) {
    ...
    return (createElement(Plugin, { name: "Basis" },
        ...
        createElement(Getter, { name: "getAnimatedStyle", value: getAnimatedStyle }),
...
var AxesLayout = function () { return (createElement(Plugin, null,
    createElement(Template, { name: "canvas" },
        createElement("div", { id: "center-center", style: { display: 'flex', flexDirection: 'column', flexGrow: 1 } },
            ...
            createElement(Template, { name: "canvas" }, function (params) { return (createElement(TemplateConnector, null, function (_a, _b) {
                ...
                return (createElement(UpdatableSizer, { containerComponent: SizerContainer, onSizeChange: function (size) { return changeBBox({ placeholder: 'pane', bBox: size }); } },
                    createElement("svg", __assign({ ref: _this.ref }, params, { width: width, height: height, style: SVG_STYLE }),
                        createElement("g", { clipPath: "url(#" + _this.clipPathId + ")" },
...
var Root = /*#__PURE__*/ (function (_super) {
    ...
    Root.prototype.render = function () {
        ...
        return (createElement("div", __assign({ style: __assign({}, style, { height: height + "px" }, width ? { width: width + "px" } : null) }, restProps), children));
    };
    return Root;
}(PureComponent));
            ...
            return (createElement(Plugin, { name: pluginName },
                ...
                createElement(Template, { name: "series" },
                    ...
                    createElement(TemplateConnector, null, function (_a) {
                        ...
                        var valScale = scales[getValueDomainName(currentSeries.scaleName)];
                        ...
                        return (createElement(Path, { index: currentSeries.index, pointComponent: currentSeries.pointComponent, coordinates: currentSeries.points, rotated: rotated, state: currentSeries.state, color: currentSeries.color, scales: currentScales, getAnimatedStyle: getAnimatedStyle }));
                    }))));
        };
...
var ArgumentScale = withPatchedProps(function (props) { return (__assign({}, props, { name: ARGUMENT_DOMAIN })); })(Scale);
var ValueScale = withPatchedProps(function (props) { return (__assign({}, props, { name: getValueDomainName(props.name) })); })(Scale);
...
var AnimationBase = /*#__PURE__*/ (function (_super) {
    ...
    AnimationBase.prototype.render = function () {
        return (createElement(Plugin, { name: "Animation" },
            createElement(Getter, { name: "getAnimatedStyle", computed: getBuildAnimatedStyle })));
    };
...
var RawArea = /*#__PURE__*/ (function (_super) {
    ...
    RawArea.prototype.render = function () {
        ...
        return (createElement("path", __assign({ d: dPath(coordinates), fill: color, opacity: 0.5, style: getAnimatedStyle(style, getAreaAnimationStyle, scales) }, restProps)));
    };
    return RawArea;
}(PureComponent));
...
var RawBar = /*#__PURE__*/ (function (_super) {
    ...
    RawBar.prototype.render = function () {
        ...
        return (createElement("rect", __assign({}, dBar(arg, val, startVal, width, rotated), { fill: color, style: getAnimatedStyle(style, getAreaAnimationStyle, scales) }, restProps)));
    };
    return RawBar;
}(PureComponent));
...
var RawPath = /*#__PURE__*/ (function (_super) {
    ...
    RawPath.prototype.render = function () {
        ...
        return (createElement("path", __assign({ d: path(coordinates), fill: "none", strokeWidth: 2, stroke: color, style: getAnimatedStyle(style, getAreaAnimationStyle, scales) }, restProps)));
    };
    return RawPath;
}(PureComponent));
...
var RawSlice = /*#__PURE__*/ (function (_super) {
    ...
    RawSlice.prototype.render = function () {
        ...
        return (createElement("g", { transform: "translate(" + x + " " + y + ")" },
            createElement("path", __assign({ d: dPie(this.props), fill: color, stroke: "none", style: getAnimatedStyle(style, getPieAnimationStyle, scales, this.props) }, restProps))));
    };
    return RawSlice;
}(PureComponent));
...
var RawPoint = /*#__PURE__*/ (function (_super) {
    ...
    RawPoint.prototype.render = function () {
        ...
        return (createElement("path", __assign({ transform: "translate(" + x + " " + y + ")", d: dSymbol(pointOptions), fill: color, stroke: "none", style: getAnimatedStyle(style, getScatterAnimationStyle, scales) }, restProps)));
    };
    return RawPoint;
}(PureComponent));
        ...
        return (createElement(Template, { name: placeholder },
            ...
            createElement(TemplateConnector, null, function (_a, _b) {
                ...
                var visibleTicks = ticks
                    .filter(createTickFilter([dx * _this.adjustedWidth, dy * _this.adjustedHeight]));
                ...
                return (createElement("div", { style: {
                    ...
                    createElement("svg", { width: _this.adjustedWidth, height: _this.adjustedHeight, style: SVG_STYLE$1 },
                        createElement(RootComponent, { dx: dx, dy: dy, onSizeChange: handleSizeChange },
                            ...
                            showLine && (createElement(LineComponent, { x1: 0, x2: dx * _this.adjustedWidth, y1: 0, y2: dy * _this.adjustedHeight })),
        ...
        return (createElement(Template, { name: "series" },
            ...
            createElement(TemplateConnector, null, function (_a) {
                ...
                return ((createElement(Fragment, null, ticks.map(function (_a) {
                    ...
                    return (createElement(GridComponent, { key: key, x1: x, x2: x + dx * width, y1: y, y2: y + dy * height }));
                }))));
            })));
    };
...
var ArgumentAxis = withPatchedProps(function (props) { return (__assign({ position: BOTTOM, showGrid: false, showTicks: true, showLine: true, showLabels: true }, props, { scaleName: ARGUMENT_DOMAIN })); })(Axis);
var ValueAxis = withPatchedProps(function (props) { return (__assign({ position: LEFT, showGrid: true, showTicks: false, showLine: false, showLabels: true }, props, { scaleName: getValueDomainName(props.scaleName) })); })(Axis);
...
var Target = /*#__PURE__*/ (function (_super) {
    ...
    Target.prototype.render = function () {
        ...
        return (createElement("path", { transform: "translate(" + x + " " + y + ")", fill: "none", ref: componentRef, d: d }));
    };
    return Target;
}(PureComponent));
...
var Tooltip = withComponents({ Target: Target })(RawTooltip);
    ...
    EventTrackerBase.prototype.render = function () {
        ...
        return (createElement(Plugin, { name: "EventTracker" },
            ...
            createElement(Template, { name: "canvas" }, function (params) { return (createElement(TemplateConnector, null, function (_a) {
                ...
                return (createElement(TemplatePlaceholder, { params: __assign({}, params, translateEventNames(handlers)) }));
            })); })));
    };
