...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var series = [];
    var getAnimatedStyle = function (style) { return style; };
    var BasicData = function (_a) {
        ...
        return (React.createElement(dxReactCore.Plugin, { name: "Basis" },
            ...
            React.createElement(dxReactCore.Getter, { name: "getAnimatedStyle", value: getAnimatedStyle }),
    ...
    var AxesLayout = function () { return (React.createElement(dxReactCore.Plugin, null,
        React.createElement(dxReactCore.Template, { name: "canvas" },
            React.createElement("div", { id: "center-center", style: { display: 'flex', flexDirection: 'column', flexGrow: 1 } },
                ...
                React.createElement(dxReactCore.Template, { name: "canvas" }, function (params) { return (React.createElement(dxReactCore.TemplateConnector, null, function (_a, _b) {
                    ...
                    return (React.createElement(UpdatableSizer, { containerComponent: SizerContainer, onSizeChange: function (size) { return changeBBox({ placeholder: 'pane', bBox: size }); } },
                        React.createElement("svg", __assign({ ref: _this.ref }, params, { width: width, height: height, style: SVG_STYLE }),
                            React.createElement("g", { clipPath: "url(#" + _this.clipPathId + ")" },
    ...
    var Root = /*#__PURE__*/ (function (_super) {
        ...
        Root.prototype.render = function () {
            ...
            return (React.createElement("div", __assign({ style: __assign({}, style, { height: height + "px" }, width ? { width: width + "px" } : null) }, restProps), children));
        };
        return Root;
    }(React.PureComponent));
    ...
    var declareSeries = function (pluginName, _a) {
        ...
        var Component = /*#__PURE__*/ (function (_super) {
            ...
            Component.prototype.render = function () {
                ...
                var seriesItem = __assign({ getPointTransformer: getPointTransformer,
                ...
                return (React.createElement(dxReactCore.Plugin, { name: pluginName },
                    ...
                    React.createElement(dxReactCore.Template, { name: "series" },
                        React.createElement(dxReactCore.TemplatePlaceholder, null),
                        React.createElement(dxReactCore.TemplateConnector, null, function (_a) {
                            var series = _a.series, scales = _a.scales, getAnimatedStyle = _a.getAnimatedStyle, rotated = _a.rotated;
                            var currentSeries = dxChartCore.findSeriesByName(symbolName, series);
                            var argScale = scales[dxChartCore.ARGUMENT_DOMAIN];
                            var valScale = scales[dxChartCore.getValueDomainName(currentSeries.scaleName)];
                            ...
                            return (React.createElement(Path, { index: currentSeries.index, pointComponent: currentSeries.pointComponent, coordinates: currentSeries.points, rotated: rotated, state: currentSeries.state, color: currentSeries.color, scales: currentScales, getAnimatedStyle: getAnimatedStyle }));
                        }))));
            };
    ...
    var ArgumentScale = withPatchedProps(function (props) { return (__assign({}, props, { name: dxChartCore.ARGUMENT_DOMAIN })); })(Scale);
    var ValueScale = withPatchedProps(function (props) { return (__assign({}, props, { name: dxChartCore.getValueDomainName(props.name) })); })(Scale);
    ...
    var getBuildAnimatedStyle = function (_a) {
        ...
        return dxChartCore.buildAnimatedStyleGetter(rotated);
    };
    var AnimationBase = /*#__PURE__*/ (function (_super) {
        ...
        AnimationBase.prototype.render = function () {
            return (React.createElement(dxReactCore.Plugin, { name: "Animation" },
                React.createElement(dxReactCore.Getter, { name: "getAnimatedStyle", computed: getBuildAnimatedStyle })));
        };
    ...
    var RawArea = /*#__PURE__*/ (function (_super) {
        ...
        RawArea.prototype.render = function () {
            var _a = this.props, path = _a.path, coordinates = _a.coordinates, index = _a.index, state = _a.state, pointComponent = _a.pointComponent, color = _a.color, style = _a.style, scales = _a.scales, getAnimatedStyle = _a.getAnimatedStyle, rotated = _a.rotated, restProps = __rest(_a, ["path", "coordinates", "index", "state", "pointComponent", "color", "style", "scales", "getAnimatedStyle", "rotated"]);
            var dPath = path === undefined ? (rotated ? dxChartCore.dRotateArea : dxChartCore.dArea) : path;
            return (React.createElement("path", __assign({ d: dPath(coordinates), fill: color, opacity: 0.5, style: getAnimatedStyle(style, dxChartCore.getAreaAnimationStyle, scales) }, restProps)));
        };
        return RawArea;
    }(React.PureComponent));
    ...
    var PointCollection = /*#__PURE__*/ (function (_super) {
        ...
        PointCollection.prototype.render = function () {
            var _a = this.props, pointComponent = _a.pointComponent, coordinates = _a.coordinates, index = _a.index, state = _a.state, restProps = __rest(_a, ["pointComponent", "coordinates", "index", "state"]) // restProps are used because of getAnimatedStyle and scale
            ;
    ...
    var RawBar = /*#__PURE__*/ (function (_super) {
        ...
        RawBar.prototype.render = function () {
            var _a = this.props, arg = _a.arg, val = _a.val, startVal = _a.startVal, barWidth = _a.barWidth, maxBarWidth = _a.maxBarWidth, argument = _a.argument, value = _a.value, seriesIndex = _a.seriesIndex, index = _a.index, state = _a.state, rotated = _a.rotated, color = _a.color, style = _a.style, scales = _a.scales, getAnimatedStyle = _a.getAnimatedStyle, restProps = __rest(_a, ["arg", "val", "startVal", "barWidth", "maxBarWidth", "argument", "value", "seriesIndex", "index", "state", "rotated", "color", "style", "scales", "getAnimatedStyle"]);
            var width = barWidth * maxBarWidth;
            return (React.createElement("rect", __assign({}, dxChartCore.dBar(arg, val, startVal, width, rotated), { fill: color, style: getAnimatedStyle(style, dxChartCore.getAreaAnimationStyle, scales) }, restProps)));
        };
        return RawBar;
    }(React.PureComponent));
    // It should actually be `withPattern<BarSeries.PointProps>` but `opacity` is not decleared there.
    // It is not clear if `opacity` should be explicitly enumerated or stay as part of `restProps`.
    var Bar = withStates((_a$1 = {},
    ...
    var RawPath = /*#__PURE__*/ (function (_super) {
        ...
        RawPath.prototype.render = function () {
            var _a = this.props, path = _a.path, coordinates = _a.coordinates, rotated = _a.rotated, index = _a.index, state = _a.state, pointComponent = _a.pointComponent, color = _a.color, style = _a.style, scales = _a.scales, getAnimatedStyle = _a.getAnimatedStyle, restProps = __rest(_a, ["path", "coordinates", "rotated", "index", "state", "pointComponent", "color", "style", "scales", "getAnimatedStyle"]);
            return (React.createElement("path", __assign({ d: path(coordinates), fill: "none", strokeWidth: 2, stroke: color, style: getAnimatedStyle(style, dxChartCore.getAreaAnimationStyle, scales) }, restProps)));
        };
        return RawPath;
    }(React.PureComponent));
    var Path = withStates((_a$2 = {},
    ...
    var RawSlice = /*#__PURE__*/ (function (_super) {
        ...
        RawSlice.prototype.render = function () {
            var _a = this.props, x = _a.arg, y = _a.val, rotated = _a.rotated, argument = _a.argument, value = _a.value, seriesIndex = _a.seriesIndex, index = _a.index, state = _a.state, maxRadius = _a.maxRadius, innerRadius = _a.innerRadius, outerRadius = _a.outerRadius, startAngle = _a.startAngle, endAngle = _a.endAngle, color = _a.color, style = _a.style, scales = _a.scales, getAnimatedStyle = _a.getAnimatedStyle, restProps = __rest(_a, ["arg", "val", "rotated", "argument", "value", "seriesIndex", "index", "state", "maxRadius", "innerRadius", "outerRadius", "startAngle", "endAngle", "color", "style", "scales", "getAnimatedStyle"]);
            return (React.createElement("g", { transform: "translate(" + x + " " + y + ")" },
                React.createElement("path", __assign({ d: dxChartCore.dPie(this.props), fill: color, stroke: "none", style: getAnimatedStyle(style, dxChartCore.getPieAnimationStyle, scales, this.props) }, restProps))));
        };
        return RawSlice;
    }(React.PureComponent));
    // It should actually be `withPattern<PieSeries.PointProps>` but `opacity` is not decleared there.
    // It is not clear if `opacity` should be explicitly enumerated or stay as part of `restProps`.
    var Slice = withStates((_a$3 = {},
    ...
    var RawPoint = /*#__PURE__*/ (function (_super) {
        ...
        RawPoint.prototype.render = function () {
            var _a = this.props, arg = _a.arg, val = _a.val, rotated = _a.rotated, argument = _a.argument, value = _a.value, seriesIndex = _a.seriesIndex, index = _a.index, state = _a.state, pointOptions = _a.point, color = _a.color, style = _a.style, scales = _a.scales, getAnimatedStyle = _a.getAnimatedStyle, restProps = __rest(_a, ["arg", "val", "rotated", "argument", "value", "seriesIndex", "index", "state", "point", "color", "style", "scales", "getAnimatedStyle"]);
            var x = rotated ? val : arg;
            var y = rotated ? arg : val;
            return (React.createElement("path", __assign({ transform: "translate(" + x + " " + y + ")", d: dxChartCore.dSymbol(pointOptions), fill: color, stroke: "none", style: getAnimatedStyle(style, dxChartCore.getScatterAnimationStyle, scales) }, restProps)));
        };
        return RawPoint;
    }(React.PureComponent));
    ...
    var Root$1 = /*#__PURE__*/ (function (_super) {
        ...
        Root.prototype.render = function () {
            var _a = this.props, children = _a.children, onSizeChange = _a.onSizeChange, restProps = __rest(_a, ["children", "onSizeChange"]);
        ...
        RawAxis.prototype.renderAxis = function (position) {
            ...
            return (React.createElement(dxReactCore.Template, { name: placeholder },
                ...
                React.createElement(dxReactCore.TemplateConnector, null, function (_a, _b) {
                    ...
                    var _d = dxChartCore.axisCoordinates({
                        scaleName: scaleName,
                        position: position,
                        tickSize: tickSize,
                    ...
                    var visibleTicks = ticks
                        .filter(dxChartCore.createTickFilter([dx * _this.adjustedWidth, dy * _this.adjustedHeight]));
                    var handleSizeChange = function (size) {
                        ...
                        if (rect.width === _this.adjustedWidth && rect.height === _this.adjustedHeight) {
                            return;
                        }
                        ...
                        _this.adjustedWidth = rect.width;
                        _this.adjustedHeight = rect.height;
                    ...
                    return (React.createElement("div", { style: {
                        ...
                        React.createElement("svg", { width: _this.adjustedWidth, height: _this.adjustedHeight, style: SVG_STYLE$1 },
                            React.createElement(RootComponent, { dx: dx, dy: dy, onSizeChange: handleSizeChange },
                                showTicks && visibleTicks.map(function (_a) {
                                ...
                                showLine && (React.createElement(LineComponent, { x1: 0, x2: dx * _this.adjustedWidth, y1: 0, y2: dy * _this.adjustedHeight })),
                                showLabels && visibleTicks.map(function (_a) {
        ...
        RawAxis.prototype.renderGrid = function () {
            ...
            return (React.createElement(dxReactCore.Template, { name: "series" },
                ...
                React.createElement(dxReactCore.TemplateConnector, null, function (_a) {
                    ...
                    var ticks = dxChartCore.getGridCoordinates({
                        scaleName: scaleName,
                        scale: scale,
                        paneSize: [_this.adjustedWidth, _this.adjustedHeight],
                        rotated: rotated,
                    ...
                    return ((React.createElement(React.Fragment, null, ticks.map(function (_a) {
                        var key = _a.key, x = _a.x, dx = _a.dx, y = _a.y, dy = _a.dy;
                        return (React.createElement(GridComponent, { key: key, x1: x, x2: x + dx * width, y1: y, y2: y + dy * height }));
                    }))));
                })));
        };
    ...
    var ArgumentAxis = withPatchedProps(function (props) { return (__assign({ position: dxChartCore.BOTTOM, showGrid: false, showTicks: true, showLine: true, showLabels: true }, props, { scaleName: dxChartCore.ARGUMENT_DOMAIN })); })(Axis);
    var ValueAxis = withPatchedProps(function (props) { return (__assign({ position: dxChartCore.LEFT, showGrid: true, showTicks: false, showLine: false, showLabels: true }, props, { scaleName: dxChartCore.getValueDomainName(props.scaleName) })); })(Axis);

    var Target = /*#__PURE__*/ (function (_super) {
        __extends(Target, _super);
        function Target() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        Target.prototype.render = function () {
            var _a = this.props, d = _a.d, x = _a.x, y = _a.y, componentRef = _a.componentRef;
            return (React.createElement("path", { transform: "translate(" + x + " " + y + ")", fill: "none", ref: componentRef, d: d }));
        };
        return Target;
    }(React.PureComponent));

    var dependencies = [{ name: 'EventTracker', optional: true }];
    var RawTooltip = /*#__PURE__*/ (function (_super) {
    ...
    var Tooltip = dxReactCore.withComponents({ Target: Target })(RawTooltip);
    ...
    var ZoomPanProvider = /*#__PURE__*/ (function (_super) {
        ...
        ZoomPanProvider.prototype.componentDidMount = function () {
            ...
            this.windowHandlers = Object.keys(events).reduce(function (prev, key) {
                ...
                if (extraEvents) {
                    return __assign({}, prev, (_a = {}, _a[key] = (_b = {},
            ...
            this.handlers = Object.keys(events).reduce(function (prev, key) {
                var _a;
                return __assign({}, prev, (_a = {}, _a[key] = function (e) {
        ...
        EventTrackerBase.prototype.render = function () {
            ...
            return (React.createElement(dxReactCore.Plugin, { name: "EventTracker" },
                ...
                React.createElement(dxReactCore.Template, { name: "canvas" }, function (params) { return (React.createElement(dxReactCore.TemplateConnector, null, function (_a) {
                    ...
                    return (React.createElement(dxReactCore.TemplatePlaceholder, { params: __assign({}, params, translateEventNames(handlers)) }));
                })); })));
        };
