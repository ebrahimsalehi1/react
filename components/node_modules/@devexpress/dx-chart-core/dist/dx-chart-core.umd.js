...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var dPie = function (_a) {
        var maxRadius = _a.maxRadius, innerRadius = _a.innerRadius, outerRadius = _a.outerRadius, startAngle = _a.startAngle, endAngle = _a.endAngle;
        return d3Shape.arc()({
    ...
    var addKeyframe = function (name, def) {
        ...
        var style = Array.from(head.getElementsByTagName('style'))
            .find(function (node) { return node.dataset[ANIMATIONS]; });
        if (!style) {
    ...
    var getDefaultAreaAnimationOptions = function () { return '1s'; };
