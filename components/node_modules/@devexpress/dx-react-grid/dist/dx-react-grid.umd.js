...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var tableBodyRowsComputed = function (_a) {
        var rows = _a.rows, getRowId = _a.getRowId;
    ...
    var TableLayoutBase = /*#__PURE__*/ (function (_super) {
        ...
        TableLayoutBase.prototype.getColumns = function () {
            ...
            if (isFixedWidth) {
                result = result.slice();
                result.push({ key: dxGridCore.TABLE_FLEX_TYPE.toString(), type: dxGridCore.TABLE_FLEX_TYPE });
            }
    ...
    var VirtualTableLayout = /*#__PURE__*/ (function (_super) {
        ...
        VirtualTableLayout.prototype.renderRowsBlock = function (name, collapsedGrid, Table, Body, blockRef, marginBottom) {
            ...
            return (React.createElement(dxReactCore.RefHolder, { ref: function (ref) { return _this.registerBlockRef(name, ref); } },
                React.createElement(Table, { tableRef: tableRef, style: __assign({ minWidth: minWidth + "px" }, marginBottom ? { marginBottom: marginBottom + "px" } : null) },
                    ...
                    React.createElement(Body, null, collapsedGrid.rows.map(function (visibleRow) {
                        ...
                        return (React.createElement(dxReactCore.RefHolder, { key: row.key, ref: function (ref) { return _this.registerRowRef(row, ref); } },
                            React.createElement(Row, { tableRow: row, style: row.height !== undefined
                                    ? { height: row.height + "px" }
                                    : undefined }, cells.map(function (cell) {
                                var column = cell.column;
                                return (React.createElement(Cell, { key: column.key, tableRow: row, tableColumn: column, style: column.animationState, colSpan: cell.colSpan }));
                            }))));
                    })))));
        };
        VirtualTableLayout.prototype.render = function () {
            var _a = this.props, headerRows = _a.headerRows, bodyRows = _a.bodyRows, footerRows = _a.footerRows, columns = _a.columns, minColumnWidth = _a.minColumnWidth, propHeight = _a.height, Container = _a.containerComponent, HeadTable = _a.headTableComponent, FootTable = _a.footerTableComponent, Table = _a.tableComponent, Head = _a.headComponent, Body = _a.bodyComponent, Footer = _a.footerComponent, getCellColSpan = _a.getCellColSpan, tableRef = _a.tableRef;
            var _b = this.state, viewportLeft = _b.viewportLeft, viewportTop = _b.viewportTop, headerHeight = _b.headerHeight, bodyHeight = _b.bodyHeight, footerHeight = _b.footerHeight, width = _b.width, height = _b.height;
            ...
            /* tslint:disable max-line-length */
            return (React.createElement(dxReactCore.Sizer, { onSizeChange: this.handleContainerSizeChange, containerComponent: Container, style: __assign({}, (propHeight === AUTO_HEIGHT ? null : { height: propHeight + "px" })), onScroll: this.updateViewport },
        ...
        StaticTableLayout.prototype.render = function () {
            ...
            return (React.createElement(Container, null,
                React.createElement(Table, { tableRef: tableRef, style: { minWidth: minWidth + "px" } },
                    ...
                    !!headerRows.length && (React.createElement(RowsBlockLayout, { rows: headerRows, columns: columns, blockComponent: headComponent, rowComponent: rowComponent, cellComponent: cellComponent, getCellColSpan: getCellColSpan })),
                    React.createElement(RowsBlockLayout, { rows: bodyRows, columns: columns, blockComponent: bodyComponent, rowComponent: rowComponent, cellComponent: cellComponent, getCellColSpan: getCellColSpan }),
                    !!footerRows.length && (React.createElement(RowsBlockLayout, { rows: footerRows, columns: columns, blockComponent: footerComponent, rowComponent: rowComponent, cellComponent: cellComponent, getCellColSpan: getCellColSpan })))));
        };
    ...
    var makeVirtualTable = function (Table, _a) {
        var VirtualLayout = _a.VirtualLayout, FixedHeader = _a.FixedHeader, FixedFooter = _a.FixedFooter, defaultEstimatedRowHeight = _a.defaultEstimatedRowHeight, defaultHeight = _a.defaultHeight;
        var VirtualTable = /*#__PURE__*/ (function (_super) {
            ...
            function VirtualTable(props) {
                ...
                _this.layoutRenderComponent = dxReactCore.connectProps(VirtualLayout, function () {
                    var _a = _this.props, height = _a.height, estimatedRowHeight = _a.estimatedRowHeight, headTableComponent = _a.headTableComponent, footerTableComponent = _a.footerTableComponent;
                    return {
                        height: height,
            ...
            VirtualTable.prototype.render = function () {
                var _a = this.props, height = _a.height, estimatedRowHeight = _a.estimatedRowHeight, headTableComponent = _a.headTableComponent, restProps = __rest(_a, ["height", "estimatedRowHeight", "headTableComponent"]);
                return (React.createElement(Table, __assign({ layoutComponent: this.layoutRenderComponent }, restProps)));
            };
