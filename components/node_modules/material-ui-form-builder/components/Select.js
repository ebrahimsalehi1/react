...
var formatSelectedValue = function formatSelectedValue(selectedValue, options) {
  if (_lodash.default.isArray(selectedValue)) {
...
function IntegrationReactSelect(_ref2) {
  var field = _ref2.field,
      ...
      others = _objectWithoutProperties(_ref2, ["field", "selectedValue", "errors", "onChange", "onInputChange", "classes"]);
  ...
  var items = field.empty && !field.multiple ? [{
    value: '',
    title: ''
  ...
  return _react.default.createElement("div", {
    ...
    onChange: function onChange(value) {
      if (field.multiple) {
        _onChange(value.map(function (item) {
          return item.value;
        }));
      } else {
...
IntegrationReactSelect.propTypes = {
  ...
  selectedValue: (0, _propTypes.oneOfType)([(0, _propTypes.oneOfType)([_propTypes.string, _propTypes.number]), (0, _propTypes.arrayOf)((0, _propTypes.oneOfType)([_propTypes.string, _propTypes.number]))]).isRequired,
  onChange: _propTypes.func.isRequired,
  errors: (0, _propTypes.shape)({})
};

var _default = (0, _styles.withStyles)(style)(IntegrationReactSelect);
