...
var ChipInput = function ChipInput(_ref2) {
  ...
  var handleKeyDown = function handleKeyDown(event) {
    ...
    switch (event.key) {
      case 'Enter':
      case 'Tab':
        _onChange([].concat(_toConsumableArray(value), [inputValue]));
  ...
  return _react.default.createElement("div", null, _react.default.createElement(_Creatable.default, {
    classes: classes,
    components: components,
    inputValue: inputValue,
    value: value.map(function (chip) {
      return {
        label: chip,
        value: chip
      };
    ...
    onChange: function onChange(items) {
      _onChange(_lodash.default.map(items, function (item) {
        return item.value;
      }));
    },
    textFieldProps: {
    ...
    isMulti: true,
    menuIsOpen: false
  }), errorText && _react.default.createElement("span", {
    style: {
      fontSize: '10px',
      color: 'red',
...
ChipInput.propTypes = {
  ...
  value: (0, _propTypes.arrayOf)((0, _propTypes.oneOfType)([_propTypes.string, _propTypes.number])).isRequired,
  onChange: _propTypes.func.isRequired,
  errors: (0, _propTypes.shape)({})
};

var _default = (0, _styles.withStyles)(styles)(ChipInput);
