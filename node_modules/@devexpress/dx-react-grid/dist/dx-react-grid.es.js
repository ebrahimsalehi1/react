...
var VirtualTableLayout = /*#__PURE__*/ (function (_super) {
    ...
    VirtualTableLayout.prototype.renderRowsBlock = function (name, collapsedGrid, Table, Body, blockRef, marginBottom) {
        ...
        return (createElement(RefHolder, { ref: function (ref) { return _this.registerBlockRef(name, ref); } },
            createElement(Table, { tableRef: tableRef, style: __assign({ minWidth: minWidth + "px" }, marginBottom ? { marginBottom: marginBottom + "px" } : null) },
                ...
                createElement(Body, null, collapsedGrid.rows.map(function (visibleRow) {
                    ...
                    return (createElement(RefHolder, { key: row.key, ref: function (ref) { return _this.registerRowRef(row, ref); } },
                        createElement(Row, { tableRow: row, style: row.height !== undefined
                                ? { height: row.height + "px" }
                                : undefined }, cells.map(function (cell) {
                            var column = cell.column;
                            return (createElement(Cell, { key: column.key, tableRow: row, tableColumn: column, style: column.animationState, colSpan: cell.colSpan }));
                        }))));
                })))));
    };
    VirtualTableLayout.prototype.render = function () {
        ...
        /* tslint:disable max-line-length */
        return (createElement(Sizer, { onSizeChange: this.handleContainerSizeChange, containerComponent: Container, style: __assign({}, (propHeight === AUTO_HEIGHT ? null : { height: propHeight + "px" })), onScroll: this.updateViewport },
    ...
    StaticTableLayout.prototype.render = function () {
        ...
        return (createElement(Container, null,
            createElement(Table, { tableRef: tableRef, style: { minWidth: minWidth + "px" } },
                ...
                !!headerRows.length && (createElement(RowsBlockLayout, { rows: headerRows, columns: columns, blockComponent: headComponent, rowComponent: rowComponent, cellComponent: cellComponent, getCellColSpan: getCellColSpan })),
                createElement(RowsBlockLayout, { rows: bodyRows, columns: columns, blockComponent: bodyComponent, rowComponent: rowComponent, cellComponent: cellComponent, getCellColSpan: getCellColSpan }),
                !!footerRows.length && (createElement(RowsBlockLayout, { rows: footerRows, columns: columns, blockComponent: footerComponent, rowComponent: rowComponent, cellComponent: cellComponent, getCellColSpan: getCellColSpan })))));
    };
...
var makeVirtualTable = function (Table, _a) {
    ...
    var VirtualTable = /*#__PURE__*/ (function (_super) {
        ...
        VirtualTable.prototype.render = function () {
            ...
            return (createElement(Table, __assign({ layoutComponent: this.layoutRenderComponent }, restProps)));
        };
